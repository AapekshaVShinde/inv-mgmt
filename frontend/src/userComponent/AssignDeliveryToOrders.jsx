    ...
    <div>
            ...
            <table className="table table-hover text-center">
              <thead className="table-bordered border-color bg-color custom-bg-text">
                <tr>
                  ...
                  <th scope="col">Inventory head Person</th>
                  <th scope="col">Inventory head Mobile No</th>
                </tr>
              </thead>
      ...
      <div>
        <div className="card form-card ms-2 me-2 mb-2 border-color custom-bg">
          <div className="card-header text-center bg-color custom-bg-text">
            <h4>Assign to Inventory head Orders</h4>
          </div>
            ...
            <form class="row g-3">
              ...
              <div className="col-auto">
                ...
                <select
                  ...
                  name="deliveryId"
                >
                  <option value="">Select Inventory head Person</option>
